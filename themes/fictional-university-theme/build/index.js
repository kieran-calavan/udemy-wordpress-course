...
//             <input readonly class="note-title-field" value="${response.data.title}">
//             <span class="edit-note"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</span>
//             <span class="delete-note"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</span>
//             <textarea readonly class="note-body-field">${response.data.content}</textarea>
//             <span class="update-note btn btn--blue btn--small"><i class="fa fa-arrow-right" aria-hidden="true"></i> Save</span>
//           </li>`
//         )
...
// 					<div class="one-third">
// 						<h2 class="search-overlay__section-title">Programs</h2>
// 						${results.programs.length ? '<ul class="link-list min-list">' : `<p>No program(s) matches that search. <a href="${universityData.root_url}/programs">View all programs</a></p>`}
